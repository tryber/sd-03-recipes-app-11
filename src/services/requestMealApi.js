...
export const searchMealsByName = (meal, type) =>
  fetch(`https://www.the${type}db.com/api/json/v1/1/search.php?s=${meal}`).then((response) =>
    response.json().then((json) => (response.ok ? Promise.resolve(json) : Promise.reject(json))),
  );

export const searchAllMealsByFirstLetter = (letter, type) =>
  fetch(`https://www.the${type}db.com/api/json/v1/1/search.php?f=${letter}`).then((response) =>
    response.json().then((json) => (response.ok ? Promise.resolve(json) : Promise.reject(json))),
  );

export const lookupFullMealDetailsById = (id, type) =>
  fetch(`https://www.the${type}db.com/api/json/v1/1/lookup.php?i=${id}`).then((response) =>
    response.json().then((json) => (response.ok ? Promise.resolve(json) : Promise.reject(json))),
  );

export const lookupSingleRandomMeal = (type) =>
  fetch(`https://www.the${type}db.com/api/json/v1/1/random.php`).then((response) =>
    response.json().then((json) => (response.ok ? Promise.resolve(json) : Promise.reject(json))),
  );

export const searchAllMealCategories = (type) =>
  fetch(`https://www.the${type}db.com/api/json/v1/1/categories.php`).then((response) =>
    response.json().then((json) => (response.ok ? Promise.resolve(json) : Promise.reject(json))),
  );

export const searchAllMealCategoriesDetails = (type) =>
